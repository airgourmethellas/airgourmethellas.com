...
// This maps menu item names to their EXACT prices in euros
...
export default function PriceFixedReview({
  formData,
  onFormDataChange,
  onPrev,
}: ReviewConfirmProps) {
  ...
  // Get the exact price for a menu item (using our hardcoded price lookup)
  const getItemPrice = (id: number): number => {
    const itemName = getMenuItemName(id);
    return MENU_PRICES[itemName] || 0;
  };

  // Calculate subtotal using our hardcoded prices
        ...
        <>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mt-6">
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-base font-medium">{formatPrice(150)}</span>
            </div>
