...
export const orders = pgTable("orders", {
  ...
  handlerCompany: text("handlerCompany").notNull(),
  ...
  passengerCount: integer("passengerCount").notNull(),
  crewCount: integer("crewCount").notNull(),
  ...
  kitchenLocation: text("kitchenLocation").notNull(), // 'Thessaloniki', 'Mykonos'
  cancellationPolicyAccepted: boolean("cancellationPolicyAccepted").notNull().default(false),
